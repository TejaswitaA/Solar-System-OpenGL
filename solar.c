...
float counterForEarth = 0,counterForEarth1 = 0,counterForEarth2 = 100,counterForEarth3 = 0,counterForEarth4 = 80,counterForEarth5 = -100,counterForEarth6= 50; 
int x1,x2,x3,x4,x5,x6,y11,y2,y3,y4,y5,y6,r1=10,r2=10,r3=10,r4=20,r5=10,r6=20;
...
glBegin(GL_POINTS);
	...
	xForEarth+=500;
	yForEarth+=350;
	if(counterForEarth>180 && counterForEarth<359) r3=20;
	else r3=10;
	...
	x1+=480;
	y11+=350;
	if(counterForEarth1>180 && counterForEarth1<359) r1=20;
	else r1=10;
	...
	x2+=500;
	y2+=350;
	if(counterForEarth2>180 && counterForEarth2<359) r2=20;
	else r2=10;
	...
	x4+=500;
	y4+=350;
	if(counterForEarth4<-180 && counterForEarth4>-359) r4=10;
	else r4=20;
	...
	x5+=500;
	y5+=350;
	if(counterForEarth5>180 && counterForEarth5<359) r5=20;
	else r5=10;
	...
	x6+=500;
	y6+=350;
	if(counterForEarth6<-180 && counterForEarth6>-359) r6=10;
	else r6=20;
}
